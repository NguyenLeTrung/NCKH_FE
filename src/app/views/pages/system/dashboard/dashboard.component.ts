import { ChangeDetectorRef, Component, OnInit, AfterViewInit, ViewChild, ElementRef, Renderer2, ViewContainerRef, OnDestroy } from '@angular/core';
...
import { INVALID } from 'src/app/helpers/constants';
...
export class DashboardComponent implements OnInit, AfterViewInit, OnDestroy{
  ...
  createToolTipData(event,id){
    ...
    let data = this.maps.find(x => x.id == id);
  ...
  positionToolTip(ele, ttid){
    ...
    let position1 = document.getElementById('position-cal').getBoundingClientRect();
