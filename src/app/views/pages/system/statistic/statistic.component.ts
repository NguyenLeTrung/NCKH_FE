  ...
  constructor(private dataPackageService: DataPackageService,
    ...
    this.columnDefs = [
      ...
      },
      {
        ...
        field: 'schoolName',
        lockPosition: true,
        tooltipField: this.translate.instant(`STATISTIC_PACKAGE.SCHOOL_NAME`),
        minWidth: 200,
        tooltip: (value: string): string => value,
        cellStyle: params => {
          if(!params.data.schoolName){
      ...
      },
      {
        ...
        field: 'levelSchool',
        lockPosition: true,
        tooltipField: this.translate.instant(`STATISTIC_PACKAGE.LEVEL`),
        tooltip: (value: string): string => value,
        minWidth: 150,
        cellStyle: params => {
          if(!params.data.schoolName){
      ...
      },
      {
        ...
        field: 'provinceName',
        minWidth: 120,
        tooltipField: this.translate.instant(`STATISTIC_PACKAGE.PROVINCE`),
        cellStyle: params => {
          if(!params.data.schoolName){
            return this.cellStyle;
          }else{
